...
- **GTX 10xx / Pascal GPUs** (e.g. GTX 1070): this project contains branch (this one!) that pins PyTorch **CUDA 12.6** builds (`cu126`), which still support compute capability 6.1. Newer `cu128+` PyTorch wheels drop Pascal support.
